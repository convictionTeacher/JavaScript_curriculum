...
window.BLANK_ANSWERS = {
  ...
  71: { inputs: [".js-blank--32"], answers: ["closest"], validation: "default" },
  72: { inputs: [".js-blank--33", ".js-blank--34"], answers: ["parentElement", "firstElementChild"], validation: "default" },
  ...
  92: { inputs: [".js-blank--44"], answers: ["cloneNode"], validation: "default" },
};
