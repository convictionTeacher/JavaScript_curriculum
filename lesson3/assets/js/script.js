...
window.BLANK_ANSWERS = {
  ...
  81: { inputs: [".js-blank--17", ".js-blank--18"], answers: ["textContent", "target"], validation: "default" },
  82: { inputs: [".js-blank--28", ".js-blank--29"], answers: ["classList", "add"], validation: "default" },
};
