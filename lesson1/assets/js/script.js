...
window.BLANK_ANSWERS = {
  11: { inputs: [".js-blank--1", ".js-blank--2"], answers: ["length", "2"], validation: "default" },
  12: { inputs: [".js-blank--4", ".js-blank--5"], answers: ["let", "log"], validation: "default" },
